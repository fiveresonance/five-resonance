...
def clean_japanese_text(text: str) -> str:
    ...
    text = text.replace("心地よい節度をもたらします", "心地よい調和をもたらします")
    text = text.replace("節度をもたらします", "調和をもたらします")
    text = text.replace("節度を保ちます", "バランスを保ちます")
    text = text.replace("節度が", "調和が")
    text = text.replace("静音", "静穏")
    # balance_note 교정 추가
    text = text.replace("際立つ気配があります", "感じられます")
    text = text.replace("する必要があります", "していきましょう")
    text = text.replace("必要があります", "大切です")
    text = text.replace("が必要です", "を取り入れていきましょう")
    text = text.replace("する必要です", "していきましょう")
    text = text.replace("ことが求められています", "ことで整えていきましょう")
    text = text.replace("ことが求められます", "ことで整えていきましょう")
    text = text.replace("求められています", "整えていくとよいでしょう")
    text = text.replace("求められます", "整えていきましょう")
    text = text.replace("を整えることで整えていきましょう", "を整えていきましょう")
    text = text.replace("ることで整えていきましょう", "ることで、バランスを取り戻しましょう")
